...
public class ProductBuilderIterator implements Iterator<Product>
{
	...
	public Product next()
	{
		...
		double quantity = (Double) productFields.get(ProductConstants.PRODUCT_QUANTITY);
		double price = product * (sum + basePrice);
		double unitPrice = price / quantity;

		productFields.put(ProductConstants.PRODUCT_UNIT_PRICE, unitPrice);
		productFields.put(ProductConstants.PRODUCT_PRICE, price);
		productFields.put(ProductConstants.PRODUCT_CATEGORY, productCategory);
